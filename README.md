...
This is a task I wanted to do in my spare time for practice while trying to create a simple improvised implementation of a desktop bot software. Since using only raw Java code to accomplish this is impossible I used the JNativeHook library which can be found here: https://github.com/kwhat/jnativehook
